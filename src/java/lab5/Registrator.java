...
public class Registrator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (name.length() < 1 || name.length() > 255) {
            msg = "Error: parameter name must be in range of 1 to 255 characters <br/>";
        }
        ...
        try {
            ...
            msg += "Error: parameter value must be an integer <br/>";
        }
        ...
        updateBean.addParameter(new Parameter(name, value));
